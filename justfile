...
test:
    nix build --print-build-logs .#homeConfigurations.bonk.activationPackage .#homeConfigurations.aarch64-linux.activationPackage .#homeConfigurations.think.activationPackage
