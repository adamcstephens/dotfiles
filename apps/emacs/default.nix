      ...
      (emacsSource.overrideAttrs (prev: {
        patches =
          [
            ...
            (pkgs.fetchpatch
              {
                url = "${inputs.emacs-plus}/patches/emacs-28/fix-window-role.patch";
            ...
            (pkgs.fetchpatch
              {
                url = "${inputs.emacs-plus}/patches/emacs-28/no-frame-refocus-cocoa.patch";
            ...
            (pkgs.fetchpatch
              {
                url = "${inputs.emacs-plus}/patches/emacs-29/poll.patch";
            ...
            (pkgs.fetchpatch
              {
                url = "${inputs.emacs-plus}/patches/emacs-28/system-appearance.patch";
